      ...
      body: CPullDownRefresh(
        child: ListView(
          children: [
            ...
            CallistoText("Total: ${widget.total}",
                size: 20, textAlign: TextAlign.center),
            CallistoText("Graded: ${widget.totalGraded}",
                size: 20, textAlign: TextAlign.center),
            CallistoText("Ungraded: ${widget.totalUngraded}",
                size: 20, textAlign: TextAlign.center),
            CallistoText("Missing: ${widget.totalMissing}",
                size: 20, textAlign: TextAlign.center),
            const CDivider(),
            Gap(10),
            AssignmentsView(
              assignments: widget.allAssignments,
              multiCourse: true,
            )
          ],
        ),
